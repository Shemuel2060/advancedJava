...
/**
 * This program shows an animation of the famous Towers of Hanoi problem, for a
 * pile
 * of ten disks. Three control buttons allow the user to control the animation.
 * A "Next" button allows the user to see just one move in the solution.
 * Clicking
 ...
 * A "Start Again" button allows the user to restart the problem from the
 * beginning.
 * 
